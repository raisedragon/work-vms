package com.winit.vms.web.displaytag;
...
public class PaginateListFactory {
	...
	public static ExtendedPaginatedList getPaginatedListFromRequest(
		...
		if (request != null) {
			...
			paginatedList
					.setSortDirection(ExtendedPaginatedList.IRequestParameters.DESC.equals(request
		...
		int pageSize = ExtendedPaginatedList.DEFAULT_PAGE_SIZE; // Rows per page
